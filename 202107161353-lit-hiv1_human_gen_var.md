...
* Now accepted that non-detectable plasma viral loads cannot transmit.
* Joint United Nations Programme on HIV/AIDS (UNAIDS) aim:
	- 90% of infected know status, 
	- 90% of those on antiviral therapy,
	- 90% of those suppressing the virus below the level of detection.
	- ~34 million on life-long chometherapy.

### HIV pharmacogenetics
Figure 5 shows the different mechanisms of pharma, including:

* Entry inhibitors, 
	- prevent the binding of the viral spike protein gp120 to host cell receptors and fusion of the virus with host cell membranes
* nucleoside and non-nucleoside reverse transcriptase inhibitors
	- prevent the reverse transcription of the viral RNA genome into DNA
* integrase inhibitors
	- prevent the integration of the viral DNA product into the host genome
* protease inhibitors
	- prevent the cleavage of viral polyproteins into their functional subunits

Human genetic variability is known to influence response to some drugs.
...
### Table 1 
**Genetic variants known to affect the pharmacokinetics of anti-HIV drugs**

| Drugs | Class | Genes | Variants | Effect on patients |
|:---|:---|:---|:---|:---|
| Abacavir | NRTI | HLA-B | rs2395029 (*57:01) | Hypersensitivity reaction |
| Atazanavir | PI | UGT1A1 | rs8175347 (*28,*37) | Predisposition to hyperbilirubinemia |
| Efavirenz | NNRTI | CYP2A6 | rs1801272 (*2), rs5031016 (*7,*10,*19), rs28399433 (*9) | Predisposition to high drug plasma levels and treatment discontinuation |
| Efavirenz and Nevirapine | NNRTI | CYP2B6 | rs3745274 (*6), rs12721655 (*8,*13), rs35303484 (*11), rs36060847 (*12), rs35773040 (*14), rs35979566 (*15), rs28399499 (*16,*18) | Predisposition to high drug plasma levels |
| Etravirine | NNRTI | CYP2C9, CYP2C19 | rs1057910 (*3), rs4424285 (*2) | Predisposition to high drug plasma levels |
| Lopinavir | PI | ABCC2, CYP3A | rs717620 (T), rs6945984 (C) | Predisposition to high drug plasma levels |
| Lopinavir | PI | SLCO1B1 | rs4149056 (*5), rs17329885 (*4) | Predisposition to low drug plasma levels |
...
Example, the allele CYP2B6*6 (rs3745274):
* Results in the slow metabolism of efavirenz and nevirapine, 
	- two non-nucleoside reverse transcriptase inhibitors recommended for first-line use by WHO until recently, 
* ~2x higher frequency in some African populations compared to Europeans.
* led to thousands of cases of treatment discontinuation in Zimbabwe when the nation adopted a single-pill efavirenz-containing regimen.
### Example from a paper we reviewed
[https://miro.medium.com/max/700/1*EWi6AcuXwRNw8tZiouycVA.gif](https://miro.medium.com/max/700/1*EWi6AcuXwRNw8tZiouycVA.gif)

["Sequencing of 53,831 diverse genomes from the NHLBI TOPMed Program" (Taliun et al., 2021)](https://lawlessgenomics.com/topic/stargazing)
Used a method of known pharmacogene (PGx) variation annotation that can be adapted for many other drug-gene database applications. 
The star allele nomenclature method is applied to large scale data to screen for possible pharmacogenomic interactions. 
Annotate allelic variation in genes impacting drug metabolism, disposition and response (e.g. of interest to clinicians prescribing medications). 
The Pharmacogene Variation (PharmVar) consortium repository is used to label human cytochrome P450 (CYP) genes for known PGx variation.
A full list of cytochrome P450 (CYP) alleles with star notation can be found via the
[Pharmacogene Variation (PharmVar)](https://www.pharmvar.org/genes) consortium.

Taliun et al. used _de novo_ genome assembly for
...
* In addition to direct interactions between host genotype and drug metabolism
* also develope chronic diseases
	- cardiovascular disease
	- metabolic syndrome
	- kidney disease
	- liver fibrosis
* all known to have high heritability in the HIV uninfected population
* some are enhanced when on therapy for HIV

* A push to develop PRS in the general population
* Only starting in HIV treatment studies
* Addition of a PRS to the known clinical and pharmacological risk factors may benefit
	- cardiometabolic diseases 
	- chronic kidney disease

* PRS are not necessarily transferable across ancestral groups
* As in all areas of genomics, attention should be paid to enhancing diversity.
